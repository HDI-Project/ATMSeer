...
export interface IProps {
    ...
    // setHyperPartition: (id?: number, dataRunId?: number) => void;
...
class DataRuns extends React.Component<IProps, IState>{
    ...
    public async getData() {
        const {
            // datarunID,
            datasetID,
            classifiers, classifiersSummary, hyperpartitions } = this.props;
...
export default connect((state: any) => ({
    ...
    // setHyperPartition: (id?: number, dataRunId?: number) => dispatch(setHyperPartitionsAction(id, dataRunId))
}))(DataRuns);
