...
def fetch_entity(entity_name, filters=None, one=False):
    ...
    try:
      ...
      if filters is None:
        ...
        reinitialize_db()
        raise ApiError('fetch entity failed', status_code=404)
...
def summarize_classifiers(dataset_id=None, datarun_id=None, hyperpartition_id=None, method=None):
    ...
    try:
      ...
      reinitialize_db()
      raise ApiError('summarize classifiers failed', status_code=404)
...
def fetch_dataset_path(dataset_id, train=True):
    ...
    try:
        ...
        reinitialize_db()
        raise ApiError('fetch dataset path failed', status_code=404)
...
def summarize_datarun(datarun_id, classifier_start=None, classifier_end=None):
    ...
    try:
        ...
        reinitialize_db()
        raise ApiError('summarize datarun failed', status_code=404)
...
def fetch_classifiers(classifier_id=None, dataset_id=None, datarun_id=None, hyperpartition_id=None,
    ...
    try:
        ...
        reinitialize_db()
        raise ApiError('fetch classifiers failed', status_code=404)
